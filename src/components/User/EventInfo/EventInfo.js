...
export default class EventInfo extends React.Component {
				...
				<div className="blokk">
					<div className="row">
						<div className="beskrivelsetabell">
							...
							<button ref="endreInfo" className="button3" onClick={() => {this.props.history.push('/changevent/' + this.arrangement.id)}}>Endre Informasjon</button>
						</div>
					<br />
	...
	componentDidMount() {
		...
		userService.getEventInfo(this.id).then((result) => {
