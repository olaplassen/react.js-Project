				...
				result.forEach(function (user) {
					users.push(
						<div>
							...
							<select key={user.id} onChange={function(e) {userService.UpsertRoleForArrangement(user.userId, e.target.value)}}>
								<option value='defaultValue' selected>-- Velg rolle -- </option>
